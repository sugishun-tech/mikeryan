import { el, avatar, button, busy, icon, richText, copy } from './dom.js?v=1.1.1';
import { cleanClient, parentId, shortKey } from '../core/utils.js?v=1.1.1';
import { profileHref, threadHref } from '../core/router.js?v=1.1.1';
